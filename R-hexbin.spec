...
Version  : 1.28.0
Release  : 26
URL      : https://cran.r-project.org/src/contrib/hexbin_1.28.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/hexbin_1.28.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1573528001
